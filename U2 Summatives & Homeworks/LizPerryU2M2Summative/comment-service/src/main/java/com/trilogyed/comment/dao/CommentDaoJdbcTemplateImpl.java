...
public class CommentDaoJdbcTemplateImpl implements CommentDao{
    ...
    public Comment getComment(int id) {
        ...
        try {
            ...
            return jdbcTemplate.queryForObject(SELECT_SQL, this::mapRowToComment, id);
    ...
    public List<Comment> getAllCommentsByPostId(int id) {
        return jdbcTemplate.query(SELECT_ALL_COMMENTS_BY_POST_ID_SQL, this::mapRowToComment, id);
    }
